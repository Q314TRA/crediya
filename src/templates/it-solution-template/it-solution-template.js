...
import { Container, Box, Row, Col } from "@ui/wrapper";
				...
				{pageData.introText && (
					<IntroArea>
						<Container>
							<Row>
								<Col lg={4}>
									<Heading {...leftHeading}>Aprende mas <span> hacerca de este tipo <br />  de creditos.</span></Heading>
								</Col>
								{pageData.introText && (
						...
						<Container>
							<Row>
								...
								{pageData.video && (
									<Col lg={6}>
										<VideoBoxWrap>
											{pageData.video.preview_image && <GatsbyImage image={getImage(pageData.video.preview_image)} alt="Video preview" align="left" />}
											<VideoBtnWrap>
